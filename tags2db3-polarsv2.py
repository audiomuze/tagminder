...
def import_dir(dbpath: str, dirpath: str) -> None:
    ...
    try:
        ...
        df = pl.DataFrame(all_tags, schema_overrides={key: pl.Utf8 for key in all_keys}) # Treat all as strings initially. This gets around Polars' idiotic col string length and type being determined by the first items sampled in a df col.
